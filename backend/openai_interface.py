        ...
        try:
            ...
            response = await self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a professional corporate investor relations assistant. Provide accurate, concise, and professional responses to investor questions based solely on the provided context."
                    },
                    {
                        "role": "user",
                        "content": prompt
